export default {
  ...
  ModelSwitchPanel: {
    ...
    legendMax: 'Max',
    legendPro: 'Pro',
    loginButton: 'Đăng nhập lại',
    newBadge: 'MỚI',
    provider: '服务商',
    quotaHint: '{{count}} lượt/ngày',
    searchPlaceholder: 'Tìm model...',
    sessionExpiredDescription:
      'Phiên đăng nhập đã hết hạn nên hệ thống chưa nhận diện được gói của bạn. Vui lòng đăng nhập lại để mở khóa các model bạn đã đăng ký.',
